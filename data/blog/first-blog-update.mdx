...
I am actively working on a the next version of DscJobs but as we all know updating
and rewriting a website and discord client from scratch takes time, dedication and patience

However the rewrite is coming along well and I should be able to announce and official release
